'''
Linear probing without updating encoder
'''
...
from models import get_clf, get_pclf
...
def main(args):
    ...
    print(pclf_name)
    exp_dir = os.path.join(args.ckpts_dir, 'seed_'+str(args.seed), args.dataset+'-'+pclf_name, 'all-linear_probing')
    ...
    optimizer = optim.SGD(fc_params, lr=args.lr, weight_decay=args.weight_decay, momentum=args.momentum, nesterov=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pretrain', type=str, default='weakly', choices=['none', 'weakly', 'fully', 'tin'])
